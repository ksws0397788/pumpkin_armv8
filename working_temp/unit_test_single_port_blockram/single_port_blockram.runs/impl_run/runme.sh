...
HD_PWD='/home/pobu/codes/pumpkin_ARMv8/working_temp/unit_test_single_port_blockram/single_port_blockram.runs/impl_run'
cd "$HD_PWD"
...
EAStep vivado -log single_port_blockram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_port_blockram.tcl -notrace
