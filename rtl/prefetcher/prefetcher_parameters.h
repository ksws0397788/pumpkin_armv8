...
`define SIG_PAGE_NUM_TAG_BITS                   8
`define SIG_PAGE_SET_INDEX_BITS                 $clog2(`SIG_TABLE_SET)
        
`define PT_TABLE_SIG_SET                        256
`define PT_TABLE_SIG_ASSOCIATIVITY              2
...
`define PT_TABLE_SIG_INDEX_BITS                 $floor($clog2(`PT_TABLE_SIG_SET)/$clog2(2))
